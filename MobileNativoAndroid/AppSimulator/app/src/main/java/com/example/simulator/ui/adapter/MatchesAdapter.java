...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Adapta od dados da partida (recuperada da API) para o nosso layout.
        ...
        if(match.getHomeTeam().getScore() != null){
            holder.binding.tvScoreboardHomeTeam.setText(String.valueOf(match.getHomeTeam().getScore()));
        }
        ...
        if(match.getAwayTeam().getScore() != null){
            holder.binding.tvScoreboardAwayTeam.setText(String.valueOf(match.getAwayTeam().getScore()));
        }
